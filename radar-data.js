...
window.RADAR_UPDATED = "2026-08-24";
window.RADAR_PRODUCTS = [
  // ---------- UTILE : rentrée et dépannage météo (le client achète parce qu'il en a besoin MAINTENANT) ----------
  {cat:"utile",name:"Parapluie pliant coupe-vent",buy:1.9,sell:8,trend:5,tag:["win","rentrée = premières pluies"],en:"3 fold auto open windproof umbrella",gt:"parapluie pliant"},
  {cat:"utile",name:"Parapluie enfant imprimé",buy:1.5,sell:7,trend:4,tag:["win","cartable + parapluie = duo rentrée"],en:"kids print umbrella manual open",gt:"parapluie enfant"},
  ...
  {cat:"utile",name:"Gants tactiles fins mi-saison",buy:1,sell:4,trend:3,tag:["win","premières fraîches du matin"],en:"touchscreen thin knit gloves",gt:"gants tactiles fins"},
  ...
  {cat:"utile",name:"Gourde isotherme enfant",buy:1.8,sell:8,trend:4,tag:["hot","cantine + goûter = rentrée"],en:"kids insulated stainless steel bottle",gt:"gourde enfant isotherme"},
  ...
  // ---------- RENTRÉE : papeterie kawaii, le rayon qui tourne fort en ce moment ----------
  {cat:"rentree",name:"Trousse peluche kawaii (capybara/axolotl)",buy:1.5,sell:7,trend:5,tag:["hot","tendance collège"],en:"plush kawaii pencil case animal",gt:"trousse peluche kawaii"},
  ...
  {cat:"rentree",name:"Protège-cahiers couleurs vives (lot)",buy:0.5,sell:3,trend:3,tag:["win","3 pour 6 €"],en:"colored notebook covers bulk",gt:"protège cahier"},

  // ---------- MODE / ACCESSOIRES : valeurs sûres + nouveautés TikTok ----------
  ...
  {cat:"cheveux",name:"Claw clips acétate à charms interchangeables",buy:1.6,sell:7,trend:5,tag:["hot","nouveauté 2026 : charms à clipser"],en:"cellulose acetate claw clip with charms",gt:"pince claw clip charm"},
  ...
  // ---------- BEAUTÉ : tendance clean girl / mob wife ----------
